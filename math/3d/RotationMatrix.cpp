/*************************************************************************
    > File Name: RotationMatrix.cpp
    > Author: etond
    > Mail: monkey_tv@126.com 
    > Created Time: 二 12/23 15:21:00 2014
 ************************************************************************/
...
void RotationMatrix::fromIntertialToObjectQuaternion(const Quaternion &q)
{
...
void RotationMatrix::fromObjectToIntertialQuaternion(const Quaternion &q) 
{
    m11 = 1.0f - 2.0f * (q.y*q.y + q.z*q.z);
    m12 = 2.0f * (q.x*q.y - q.w*q.z);
    m13 = 2.0f * (q.x*q.z + q.w*q.y);
